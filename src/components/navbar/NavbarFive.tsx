...
const NavbarFive = () => {
  ...
  return (
    <header className={`top-0 z-[200] ${windowHeight > 200 && "sticky"}`}>
      <div>
        {/* navbar start */}
        ...
        <nav className="relative">
          <div
            className={` theme-transition-3 ${
              windowHeight > 200 && "bg-white shadow-md"
            } border-b border-neutral-30 py-3 font-medium`}
          >
            <div
            ...
            >
              ...
              <div className="hidden items-center justify-between  xxl:flex">
                <div className="gap-40px flex items-center">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    {/* search bar */}
                    <div className="z-30 w-[400px] pe-6 4xl:w-[450px]">
                      <SearchBarPrimary />
                    </div>
                  </div>
                </div>
                <div className="z-50 flex items-center gap-4 py-2 4xl:gap-6">
                  <HeaderIcon
              ...
              <div className="flex h-full items-center justify-between xxl:hidden">
                ...
                <div
                  className={`visible absolute left-0 top-[67px] z-[2000] h-screen min-h-full w-full overflow-hidden pb-[106px] transition-all duration-1000 lg:top-[70px] ${
                    menuOpen
