...
const SearchBarMobileFour = () => {
  ...
  return (
    <div className="lg:hidden">
      ...
      <div
        className={` absolute left-0 top-0 z-50 bg-secondaryColorTwo opacity-100 transition-all duration-700 ${
      ...
      >
        <div className="flex w-[100vw] items-center justify-between gap-6 px-4 py-3 max-sm:flex-col-reverse">
          ...
          <div className="items-center gap-2 max-sm:flex">
            ...
            <div>
              <div
                className="text-sebg-secondaryColorTwo rounded-full bg-bgColorTwo  p-2 sm:hidden"
          ...
          <div
            className=" text-sebg-secondaryColorTwo rounded-full bg-bgColorTwo  p-2 max-sm:hidden"
            onClick={() => setSearchModalOpen(!searchModalOpen)}
          >
            <IconX size={30} />
          </div>
...
export default SearchBarMobileFour;
