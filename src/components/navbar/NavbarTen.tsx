...
import SearchBarPrimary from "../sharedComponents/SearchbarPrimary";
  ...
  return (
    <header className="border-b">
      <div>
        ...
        <nav className="relative z-50 overflow-x-clip">
          <div
            className={` theme-transition-3  z-[100] py-3 font-medium ${
              windowHeight > 150
                ? "fixed left-0 right-0 top-0 z-[100] backdrop-blur-2xl backdrop-brightness-100 backdrop-contrast-100"
                : ""
            }`}
          >
            <div
            ...
            >
              ...
              <div className=" hidden items-center justify-between xxl:flex">
                <div className="gap-40px flex items-center">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    {/* search bar */}
                    <div className="w-[400px] pe-6 4xl:w-[450px]">
                      <SearchBarPrimary />
                    </div>
                  </div>
                </div>
              ...
              <div className="flex h-full items-center justify-between xxl:hidden">
                ...
                <div
                  className={`visible absolute left-0 top-[67px] z-[2000] h-screen min-h-full w-full overflow-hidden overflow-x-hidden overflow-y-scroll pb-[106px] transition-all duration-1000 lg:top-[70px] ${
                    menuOpen
                ...
                <div className="items-center gap-3 max-lg:flex sm:gap-6">
                  ...
                  <div className="relative flex items-center gap-6">
                    ...
                    <div
                      className={`right-[-10px] top-10 z-[2000] flex translate-y-0 items-center gap-2 transition-all duration-300 max-xxl:absolute max-xxl:z-20 max-xxl:w-[180px] max-xxl:flex-col max-xxl:justify-center max-xxl:space-y-2 max-xxl:rounded-sm max-xxl:bg-neutral-10 max-xxl:px-5 max-xxl:py-6 max-xxl:shadow-md md:top-11 lg:justify-between xxl:gap-6 ${
                        buttonModalOpen
