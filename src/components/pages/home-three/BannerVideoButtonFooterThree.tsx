...
const BannerVideoButtonFooterThree = () => {
    ...
    <>
      <div className="rounded-full bg-primaryColor p-2 ">
        <div className="relative">
          ...
          />
          <div className="absolute left-1/2 top-1/2 z-30 -translate-x-1/2 -translate-y-1/2 rounded-full  bg-bgColorOne p-3 sm:p-7 ">
            <button
...
export default BannerVideoButtonFooterThree;
