...
import MostSellingCoursesTable from "./MostSellingCoursesTable";
...
// { tableContent }: { tableContent: Props }
const MostSellingCourses = ({ tableContent }: { tableContent: Props }) => {
  const category = [
    { label: "All" },
    { label: "Weekly" },
    { label: "Monthly" },
  ...
  return (
    <div className="padding-all-32 flex flex-col gap-6 rounded-16px bg-white">
      ...
      <MostSellingCoursesTable tableData={tableData} />
      {/* table contents end */}
      {tableData.length > 0 && (
        <>
          <div>
